document.write(`
<div class="paragraph" id="contentMobile">
    <img
      class="logo"
      src="./assets/mrgreen-logo-white.svg"
      alt="mr green logo"
    />
    ...
    <h2 class="subheader content-subtitle">Spela Casino Online hos Mr Green</h2>

    <p class="header_paragraph content-paragraph">
    ...
    <h3 class="login content-login">Redan medlem? <span class="openLogin soft-green pointer">Logga in</span></h3>
